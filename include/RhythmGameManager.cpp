...
RhythmGameManager::RhythmGameManager(std::vector<NoteData> notes, std::vector<BpmData> bpms, double offset, bool isAuto):rhythmManager(bpms,offset), isAuto(false){
  for (auto i : notes) {
