...
void MusicSelection::draw() const {
  ...
  font60(ToString(getData().getPlayNum() + 1) + U"/" + ToString(getData().getMaxPlayNum()) +U" 曲目").draw(playerStartX, playerStartY);
  ...
  // *** Level ***
  std::array<String, 3> levelStr({ U"かんたん", U"ふつう", U"むずかしい" });
